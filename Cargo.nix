    ...
    crates = {
      ...
      "madori" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          sha256 = "18hl69pyjpl11aqrsnd5878imfsf6a42rnqhggnapmxa873c9y5w";
        };
        dependencies = [
          {
            name = "egaku";
      ...
      "tear-client" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "212bb4321202945fc3235db82ae31ad261daf916";
          sha256 = "02dcp811f7by3whc1d5ya2bnxi2gg7wksb6kn35wwlz2hsb5if0p";
        };
        libName = "tear_client";
        authors = [
          "pleme-io"
