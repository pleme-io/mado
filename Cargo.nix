    ...
    crates = {
      ...
      "garasu" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "6c3a65f66f67d51e25bf5fe4de452b6a1d5c4f2d";
          sha256 = "12f8ghn8s69fribf90l9x343kc82x4v6ikzy455f0nfb0m8p4mmg";
        };
        dependencies = [
          {
            name = "blake3";
      ...
      "tear-client" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "8a605b10f4c90dbef8ae7d9a98a9954c87b79815";
          sha256 = "14696bpqihg5949x54sby30pf062ixipm8wxn1gnpmisjwczdaxw";
        };
        libName = "tear_client";
        authors = [
          "pleme-io"
