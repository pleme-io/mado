    ...
    crates = {
      ...
      "engawa" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "acb36403ea7af6483c728496527ca2184603ca3c";
      ...
      "engawa-lisp" = rec {
        crateName = "engawa-lisp";
        version = "0.1.0";
        edition = "2024";
        workspace_member = null;
        src = pkgs.fetchgit {
          url = "https://github.com/pleme-io/engawa-lisp";
          rev = "369bbb4bdf9aea48fd90de8d10cfff5102a3abe7";
      ...
      "engawa-snow" = rec {
        crateName = "engawa-snow";
        version = "0.1.0";
        edition = "2024";
        workspace_member = null;
        src = pkgs.fetchgit {
          url = "https://github.com/pleme-io/engawa-snow";
          rev = "7f1a4dd32ef95eaf12a3eefa578ffe67f5e193e4";
      ...
      "engawa-wgpu" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "0c5533cb3ebceabec167839e56839f69f6348ccd";
      ...
      "garasu" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "c0494d004b20f3653c28ad47744a8505fc41f7c1";
          sha256 = "0k6jqmml8p83qc2bi2vpv611c4ig8305bcg85slzpplfxv0a0d71";
        };
        dependencies = [
          {
            name = "bincode";
      ...
      "madori" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "5a40dce7daf4c1b5fece817636677ff5dd3be1e8";
      ...
      "nix 0.31.3" = rec {
        ...
        resolvedDefaultFeatures = [ "fs" "poll" "process" "signal" ];
      };
      "no-std-compat" = rec {
      ...
      "objc2-app-kit 0.2.2" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "objc2-core-data 0.2.2";
            optional = true;
            usesDefaultFeatures = false;
            target = { target, features }: ("apple" == target."vendor" or null);
          }
          {
            ...
            packageId = "objc2-core-image 0.2.2";
            optional = true;
            usesDefaultFeatures = false;
            target = { target, features }: ("apple" == target."vendor" or null);
          }
      ...
      "objc2-app-kit 0.3.2" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "objc2-cloud-kit 0.3.2";
            optional = true;
            usesDefaultFeatures = false;
            target = { target, features }: ("apple" == target."vendor" or null);
          ...
          {
            name = "objc2-core-data";
            packageId = "objc2-core-data 0.3.2";
            optional = true;
            usesDefaultFeatures = false;
            target = { target, features }: ("apple" == target."vendor" or null);
          ...
          {
            name = "objc2-core-image";
            packageId = "objc2-core-image 0.3.2";
            optional = true;
            usesDefaultFeatures = false;
            target = { target, features }: ("apple" == target."vendor" or null);
      ...
      "objc2-ui-kit" = rec {
        ...
        dependencies = [
          ...
          {
            name = "objc2-cloud-kit";
            packageId = "objc2-cloud-kit 0.2.2";
            optional = true;
            usesDefaultFeatures = false;
          }
          {
      ...
      "rmcp" = rec {
        ...
        resolvedDefaultFeatures = [ "base64" "client" "default" "macros" "server" "transport-async-rw" "transport-child-process" "transport-io" ];
      };
      "rmcp-macros" = rec {
      ...
      "shidou" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "bd1f0b5ac46c39be9869ab2b7293deae9b0617b5";
      ...
      "tear-client" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "62e93f630c5d2771772801ac50bf8be4ed519745";
          sha256 = "0sla6xvz1ll8j98d0xnk8bvgjcbrzrl7jm84d7ffpynw2bp8a7nx";
        };
        libName = "tear_client";
        authors = [
          "pleme-io"
