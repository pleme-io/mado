    ...
    crates = {
      ...
      "engawa-snow" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "15929f09e34a101c2119419a42c6efb0514ad4d2";
          sha256 = "0fq9rw69rs220c6lm1ykslsif3br8lkylqda8y20867wah36rqya";
        };
        libName = "engawa_snow";
        authors = [
          "pleme-io"
      ...
      "tear-client" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "4bff8f4875c8185a782590298d4f6d6add4311a1";
          sha256 = "0d09f7g1bwxmqrp5g1z2fa1wyx7z9fwxsr17ddxsc5vvqr28bqa8";
        };
        libName = "tear_client";
        authors = [
          "pleme-io"
